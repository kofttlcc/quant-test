...
name: canvas-design
description: >-
  Create beautiful visual art in .png and .pdf 文檔 using design philosophy. You
  should use this skill when the user asks to create a poster, piece of art,
...
trigger: when_needed
language: zh-TW
adapted_from: openskills/canvas-design
