...
description: >-
  Extracts and 分析s competitors' ads from ad libraries (Facebook, LinkedIn, etc.)
  to understand what messaging, problems, and creative approaches are working.
  Helps inspire and improve your own ad campaigns.
trigger: when_needed
language: zh-TW
adapted_from: openskills/competitive-ads-extractor
version: 1.0.0-antigravity
original_license: Unknown
---
# COMPETITIVE-ADS-EXTRACTOR 處理指南

> **技能版本**: v1.0 (Antigravity 適配版)  
> **原始來源**: openskills/competitive-ads-extractor  
> **語言**: 繁體中文

## 概述

Extracts and 分析s competitors' ads from ad libraries (Facebook, LinkedIn, etc.) to understand what messaging, problems, and creative approaches are working. Helps inspire and improve your own ad campaigns.
...
- Enterprise: 安全 and compliance mentions
