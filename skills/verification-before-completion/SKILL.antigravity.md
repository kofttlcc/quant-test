...
trigger: when_needed
language: zh-TW
adapted_from: openskills/verification-before-completion
version: 1.0.0-antigravity
original_license: Unknown
---
# VERIFICATION-BEFORE-COMPLETION 處理指南

> **技能版本**: v1.0 (Antigravity 適配版)  
> **原始來源**: openskills/verification-before-completion  
> **語言**: 繁體中文
...
| 需求 met | Line-by-line checklist | Tests passing |
